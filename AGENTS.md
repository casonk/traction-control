...
| `private-repository` | `./health-repos/private-repository` | Python | Private supplement sourcing and schema-enrichment tooling |
| `private-repository` | `./private-repository` | Python | Personal finance ingestion, normalization, and reporting |
...
| `private-repository` | `./util-repos/private-repository` | Bash / Shell | TPM2/clevis LUKS auto-unlock for home desktop data volumes (private) |
| `nordility` | `./util-repos/nordility` | Python package | NordVPN CLI/API automation |
| `private-repository` | `./util-repos/private-repository` | Python package | PGP encryption/decryption helpers with auto-pass key storage and shock-relay message sending |
...
| `private-repository` | `./util-repos/private-repository` | Python / Flask | Phone-friendly GPS trace collection with local SQLite storage and CSV/GeoJSON exports |
...
- `./util-repos/private-repository`: PGP encryption/decryption helpers, KeePassXC-backed key bundles through `auto-pass`, and encrypted email handoff through `shock-relay`
...
- `./util-repos/private-repository`: phone-friendly GPS trace collection, local SQLite storage, and CSV/GeoJSON exports
...
- `./util-repos/private-repository`: standard PGP encryption/decryption and encrypted-message handoff utility for other repos
...
- `./util-repos/private-repository`: standard phone GPS trace collection utility with local SQLite storage and CSV/GeoJSON exports
...
- `./private-repository`: strongest CI, test depth, and contributor workflow baseline
