...
EXPECTED_SUCCESS_LOG=$'gh\trepo\tcreate\tcasonk/differential\t--private\ngh\trepo\tview\tcasonk/differential\t--json\tisPrivate\t--jq\t.isPrivate'
...
INVALID_SLUGS=(
  ...
  "/differential"
  "casonk/"
  "casonk/differential/extra"
  "-casonk/differential"
  "casonk-/differential"
  "case--onk/differential"
  "case_onk/differential"
  "casonk/-differential"
  "casonk/differential@main"
  "casonk/differential repo"
  "casonk/."
  "casonk/.."
  "casonk/differential --public"
  "ownerownerownerownerownerownerownerownerowner/differential"
...
run_without_gh casonk/differential
...
FAKE_GH_IS_PRIVATE=true
run_wrapper casonk/differential
assert_status 0 "private repository creation succeeds"
assert_output_contains \
  "created and verified private repository: casonk/differential" \
...
assert_log_equals $'gh\trepo\tcreate\tcasonk/differential\t--private' \
