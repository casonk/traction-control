...
TEMPLATE_PATH="${REPO_ROOT}/config/clockwork/archility-weekly.toml.template"
...
systemctl --user enable --now archility-weekly.timer
systemctl --user list-timers archility-weekly.timer
